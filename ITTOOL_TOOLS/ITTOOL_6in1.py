...
#  Script: ITTOOL_6in1.py
#  ScriptID: (pending)
#  Version: 1.0
#  Date: 2026-06-18
#  Category: Tools > Maintenance > 6-in-1 Launcher
#  Description: Menu launcher for the 6 ITTOOL maintenance scripts. It only
...
# The 6 scripts must sit next to it (same folder).
# ---------------------------------------------------------------------------
...
def show_header():
    ...
    print(f"  {DCYAN}Script: ITTOOL_6in1.py{RESET}")
    print(f"  {DCYAN}Version: 1.0{RESET}")
    print(f"  {DCYAN}Date: 2026-06-18{RESET}")
    print(f"  {DCYAN}Category: Tools > Maintenance > 6-in-1 Launcher{RESET}")
    print(f"  {DCYAN}Description: 6-in-1 launcher for the ITTOOL maintenance scripts{RESET}")
...
def show_menu():
    print()
    print(f"  {WHITE}================================================={RESET}")
    print(f"  {WHITE}  ITTOOL Tools - 6 in 1{RESET}")
    print(f"  {WHITE}================================================={RESET}")
